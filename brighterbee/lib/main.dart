...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return SplashScreen(
      ...
      title: Text("welcome to brighterbee",style: TextStyle(fontWeight: FontWeight.bold
      ...
      pages: [
        PageViewModel(
          ...
          bodyWidget: Row(
            ...
            children: const [
              Expanded(child: Text("Social good apps can be used to educate and to provide that specific skill set which makes that student fir for hiring", style: bodyStyle)),
            ],
          ),
        ...
        PageViewModel(
          title: "Get Prepared",
          body:
          "It is good to rub , and polish our brain against of others",
          image: Image.network("https://flutter.io/images/catalog-widget-placeholder.png"),
          decoration: pageDecoration,
        ),
        PageViewModel(
        ...
        PageViewModel(
          ...
          body: "we provide mentorship form industrail experts and easy to understand contents",
          image: Image.network("https://flutter.io/images/catalog-widget-placeholder.png"),
          decoration: pageDecoration,
        ),
        PageViewModel(
          ...
          bodyWidget: Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: const [
              Expanded(child: Text("Click on Done to start your new journey", style: bodyStyle)),
            ],
          ),
          image:Image.network("https://flutter.io/images/catalog-widget-placeholder.png"),
          decoration: pageDecoration,
